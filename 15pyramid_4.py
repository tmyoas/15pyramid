...
# The number of odd is 8 and even is 7 in 1-15.
# So, ans[0] is limited some pattern.
# For example, [even, even, even, even, even] is completely wrong because even - even = even. Odd can't see in this pattern.
...
if __name__ == '__main__':
    ...
    accepted_list = parity_accepted_list()

    with open('log_4.txt', mode='w') as f:
